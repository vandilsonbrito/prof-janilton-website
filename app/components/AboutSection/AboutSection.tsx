'use client'
import Janilton from '../../../public/about-pic.webp';
import JaniltonMobile from '../../../public/about-pic-mobile.webp';
import Aos from 'aos';
...
export default function AboutSection() {
  ...
  return (
    <section className="w-full max-w-[90rem] h-full bg-white my-10 font-Montserrat flex flex-col items-center  sm:my-16 px-5 sm:px-12 xl:px-24 lg:mb-20 text-black" id='/sobre'>
        ...
        <div className="w-full h-full flex flex-col xl:flex-row items-center gap-3 lg:gap-10">
            <div className="w-full h-full flex justify-center xl:self-start xl:mt-2" data-aos="fade-up">
              <Image 
                ...
                className='w-[190px] h-[245px] lg:w-[280px] lg:h-[380px] rounded-md my-6 sm:my-10 xl:my-0 flex '/>
            </div>
            ...
            <div className="flex flex-col gap-5 text-lg md:text-xl lg:text-lg md:-px-10" data-aos="fade-up">
                ...
                <p>Seja bem-vindo ao meu mundo de conhecimento, aprendizado e descobertas. Estou ansioso para compartilhar essa jornada educacional com você. Vamos nessa! <Link href='/sobre' className='hover:underline cursor-pointer text-blue-600' aria-label="Leia mais sobre Janilton Almeida"> Mais sobre.</Link></p>
            </div>
        </div>
    </section>
  )
